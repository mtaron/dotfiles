...
`*.sh.tmpl` files can be further validated by piping the result to shellcheck, e.g. `chezmoi execute-template < home/.chezmoiscripts/ubuntu/run_onchange_before_bat.sh.tmpl | shellcheck --external-sources -`
